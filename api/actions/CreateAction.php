 ...
 * @since 2.0
 */
class CreateAction extends \api\actions\Action
{
    /**
    ...
    public function run()
    {
        ...
        if($this->doCreate){
            ...
            if (is_array($postData)) {
                if(count($postData) < $this->minCountData)
            ...
            $result = call_user_func($this->doCreate, $data);
        }
        if($this->responseSuccess){
            return  call_user_func($this->responseSuccess, $result);
        }
