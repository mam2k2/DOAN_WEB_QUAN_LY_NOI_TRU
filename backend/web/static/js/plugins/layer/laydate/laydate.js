    ...
    Class.prototype.lang = function(){
        var that = this
            ...
            vi: {
                ...
                ,timeout: 'Thời gian kết thúc không được nhỏ hơn Thời gian bắt đầu<br>Vui lòng chọn lại'
                ,invalidDate: 'Ngày không hợp lệ'
                ,formatError: ['Lỗi định dạng ngày<br>Phải tuân theo：<br>', '<br>Nó đã được thiết lập lại']
