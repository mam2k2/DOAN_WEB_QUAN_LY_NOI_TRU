...
class AppAsset extends \yii\web\AssetBundle
{
    ...
    public $css = [
        ...
        'static/vuexy/vendor/fonts/tabler-icons.css',
        'static/vuexy/vendor/fonts/flag-icons.css',
        'static/vuexy/vendor/css/rtl/core.css',
        'static/vuexy/vendor/css/rtl/theme-default.css',
    ...
    public $js = [
        ...
        'static/vuexy/vendor/js/bootstrap.js',
        ...
        'static/vuexy/vendor/libs/popper/popper.js',
    ];
