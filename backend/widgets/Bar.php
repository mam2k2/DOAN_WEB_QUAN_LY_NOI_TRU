    ...
    protected function initDefaultButtons()
    {
        if (! isset($this->buttons['refresh'])) {
            $this->buttons['refresh'] = function () {
                return Html::a('<i class="fa fa-refresh"></i>&nbsp' . Yii::t('app', 'Refresh'), Url::to(['refresh']), [
        ...
        if (! isset($this->buttons['create'])) {
            $this->buttons['create'] = function () {
                return Html::a('<i class="fa fa-plus"></i>&nbsp' . Yii::t('app', 'Create'), Url::to(['create']), [
        ...
        if (! isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function () {
                return Html::a('<i class="fa fa-trash-o"></i>&nbsp' . Yii::t('app', 'Delete'), Url::to(['delete']), [
