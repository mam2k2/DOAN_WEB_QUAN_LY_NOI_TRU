...
/**
 * DiemDanhSearch represents the model behind the search form about `common\models\DiemDanh`.
 */
class DiemDanhSearch extends DiemDanh implements \backend\models\search\SearchInterface
{
    /**
     * @inheritdoc
     */
