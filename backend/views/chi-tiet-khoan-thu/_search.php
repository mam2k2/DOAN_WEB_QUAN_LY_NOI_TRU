...
/* @var $model backend\models\search\ChiTietKhoanThuSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="chi-tiet-khoan-thu-search ibox-heading row search" style="margin-top: 5px;padding-top:5px">
    ...
    <?= $form->field($model, 'thu_phi_noi_tru_id', ['options'=>['class'=>'col-sm-3']]) ?>
