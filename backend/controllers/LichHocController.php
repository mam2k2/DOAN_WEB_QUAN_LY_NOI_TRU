...
use Yii;
use common\services\LichHocServiceInterface;
use common\services\LichHocService;
 ...
 */
class LichHocController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var LichHocServiceInterface $service */
        $service = Yii::$app->get(LichHocServiceInterface::ServiceName);
        return [
            'index' => [
