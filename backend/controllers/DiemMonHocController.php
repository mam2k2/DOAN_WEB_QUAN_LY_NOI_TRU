...
use Yii;
use common\services\DiemMonHocServiceInterface;
use common\services\DiemMonHocService;
...
/**
 * DiemMonHocController implements the CRUD actions for DiemMonHoc model.
 */
class DiemMonHocController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var DiemMonHocServiceInterface $service */
        $service = Yii::$app->get(DiemMonHocServiceInterface::ServiceName);
        return [
            'index' => [
