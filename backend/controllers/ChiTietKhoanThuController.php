...
use Yii;
use common\services\ChiTietKhoanThuServiceInterface;
use common\services\ChiTietKhoanThuService;
...
/**
 * ChiTietKhoanThuController implements the CRUD actions for ChiTietKhoanThu model.
 */
class ChiTietKhoanThuController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var ChiTietKhoanThuServiceInterface $service */
        $service = Yii::$app->get(ChiTietKhoanThuServiceInterface::ServiceName);
        return [
            'index' => [
