...
use Yii;
use common\services\MonHocServiceInterface;
use common\services\MonHocService;
 ...
 */
class MonHocController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var MonHocServiceInterface $service */
        $service = Yii::$app->get(MonHocServiceInterface::ServiceName);
        return [
            'index' => [
