...
use Yii;
use common\services\PhongOHocSinhServiceInterface;
use common\services\PhongOHocSinhService;
...
/**
 * PhongOHocSinhController implements the CRUD actions for PhongOHocSinh model.
 */
class PhongOHocSinhController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var PhongOHocSinhServiceInterface $service */
        $service = Yii::$app->get(PhongOHocSinhServiceInterface::ServiceName);
        return [
            'index' => [
