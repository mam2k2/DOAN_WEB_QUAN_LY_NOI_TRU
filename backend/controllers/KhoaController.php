...
use common\services\KhoaService;
 ...
 */
class KhoaController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var KhoaServiceInterface $service */
        $service = Yii::$app->get(KhoaServiceInterface::ServiceName);
        return [
            'index' => [
