...
use Yii;
use common\services\ThongBaoHeThongServiceInterface;
use common\services\ThongBaoHeThongService;
...
/**
 * ThongBaoHeThongController implements the CRUD actions for ThongBaoHeThong model.
 */
class ThongBaoHeThongController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var ThongBaoHeThongServiceInterface $service */
        $service = Yii::$app->get(ThongBaoHeThongServiceInterface::ServiceName);
        return [
            'index' => [
