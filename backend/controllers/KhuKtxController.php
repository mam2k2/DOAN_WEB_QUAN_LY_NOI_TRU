...
use common\services\KhuKtxService;
...
/**
 * KhuKtxController implements the CRUD actions for KhuKtx model.
 */
class KhuKtxController extends \yii\web\Controller
{
    public function actions()
    {
        /** @var KhuKtxServiceInterface $service */
        $service = Yii::$app->get(KhuKtxServiceInterface::ServiceName);
        return [
            'index' => [
