...
use Yii;
use common\services\TicketsServiceInterface;
use common\services\TicketsService;
...
class TicketsController extends \yii\web\Controller
{
    ...
    {
        /** @var TicketsServiceInterface $service */
        $service = Yii::$app->get(TicketsServiceInterface::ServiceName);
        return [
            'index' => [
